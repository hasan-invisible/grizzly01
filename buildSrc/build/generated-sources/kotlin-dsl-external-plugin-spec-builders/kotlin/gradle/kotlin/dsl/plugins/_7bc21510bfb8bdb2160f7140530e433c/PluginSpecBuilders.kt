...
package gradle.kotlin.dsl.plugins._7bc21510bfb8bdb2160f7140530e433c
...
/**
 * The `com.gradleup.nmcp` plugin implemented by [nmcp.NmcpPlugin].
 */
internal
val `ComGradleupPluginGroup`.`nmcp`: PluginDependencySpec
    get() = plugins.id("com.gradleup.nmcp")
...
/**
 * The `dev.adamko.dev-publish` plugin implemented by [dev.adamko.gradle.dev_publish.DevPublishPlugin].
 */
internal
val `DevAdamkoPluginGroup`.`dev-publish`: PluginDependencySpec
    get() = plugins.id("dev.adamko.dev-publish")
